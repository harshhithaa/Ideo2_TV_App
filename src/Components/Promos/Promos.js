...
const mapDispatchToProps = dispatch => ({
  // Only map the actions this component actually uses. Other actions
  // referenced in the legacy code were moved or are app-level; keep
  // these as no-ops here to avoid undefined references.
