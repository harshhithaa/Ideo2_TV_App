...
// import convertToProxyURL from 'react-native-video-cache'; // removed react-native-video-cache (not installed). Use direct MediaPath URIs instead.
      ...
      <View style={{flex:1}}>
        ...
        <Animated.View style={{
          ...
          {current && (current.MediaType === 'image' || current.MediaType === 'gif') ? (
            ...
            <Video
              source={{ uri: current?.MediaPath || null }}
               resizeMode={'stretch'}
               onLoad={(data) => {
